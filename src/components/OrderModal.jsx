              ...
              <div className="w-full min-w-0 max-w-full">
                ...
                >
                  ...
                  <input
                    ...
                    value={formData.date}
                    onChange={handleChange}
                    className="w-full h-11 block min-w-0 max-w-full overflow-hidden box-border bg-slate-950 border border-slate-800 rounded-xl pl-9 pr-3 py-2 text-base sm:text-sm text-white focus:outline-none focus:border-amber-500 transition-colors font-medium cursor-pointer [&::-webkit-calendar-picker-indicator]:cursor-pointer [&::-webkit-calendar-picker-indicator]:opacity-80 hover:[&::-webkit-calendar-picker-indicator]:opacity-100"
                  />
                </div>
              </div>
